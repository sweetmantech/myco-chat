...
export function AppDownloadModal() {
  ...
  return (
    <div className='fixed font-nounish text-black !top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col space-y-4  w-8/12 mx-auto bg-transparent'>
      <div className='rounded-3xl border border-black p-4 flex flex-col space-y-10 shadow-2xl'>
      ...
      <button onClick={() => setIsInstallable(false)} className='text-black rounded-full border border-black px-6 py-3 font-bold shadow-2xl'>Not Now</button>
    </div>
  );
} 